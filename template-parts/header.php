	...
	<header id="masthead" class="site-header<?php echo is_singular() ? ' header-single' : ''; ?>" style="<?php header_style(); ?>">
		...
		<div class="site-header--inner">
			...
			<div class="site-branding">
				...
				<?php if ( is_category() || is_archive() ) : // CATEGORY ARCHIVE ?>
				...
				<?php if ( is_singular() ) : // SINGULAR POST ?>
					...
					<?php if ( 'post-standard' === $template ) : ?>
						<h6 class="entry-category-date page-category-date"><?php the_permalink_date( '', '<br>', false ); ?><?php the_category( ', ' ); ?></h6>
						<h6 class="entry-kicker page-kicker"><?php the_kicker(); ?></h6>
