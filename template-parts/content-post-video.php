...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'content h-entry post-entry type-post-video' ); ?>>
	<div class="content-card type-video">
		...
		<footer class="entry-footer">
			...
			<?php endif; ?>
			<?php get_template_part( 'template-parts/partial-interactions', 'video' ); ?>
		</footer><!-- .entry-footer -->
		<?php endif; ?>
