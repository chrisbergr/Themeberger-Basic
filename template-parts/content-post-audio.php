...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'content h-entry post-entry type-post-audio' ); ?>>
	<div class="content-card type-audio">
		...
		<footer class="entry-footer">
			...
			<?php endif; ?>
			<?php get_template_part( 'template-parts/partial-interactions', 'audio' ); ?>
		</footer><!-- .entry-footer -->
		<?php endif; ?>
