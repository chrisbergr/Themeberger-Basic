...
<?php if ( is_single() ) : ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'content h-entry post-entry type-post-' . $post_type_slug ); ?> itemscope itemtype="http://schema.org/BlogPosting">
		...
		<div class="content-card type-<?php echo esc_attr( $post_type_slug ); ?>">
			...
			<?php if ( has_post_thumbnail() && $layout !== 'layout-headercover' ) : ?>
			<div class="entry-image more-width-block"><?php the_post_thumbnail(); ?></div>
			<?php endif; ?>

			<header class="entry-header" style="display:none;">
				<?php $utils->the_author_vcard(); ?><?php if ( ! is_single() ) : ?>
					<?php $utils->the_permalink_date( '<span class="themeberger-date">', '</span>', true ); ?>
				<?php endif; ?>
				<?php if ( is_singular() ) : ?>
		...
		<footer class="entry-footer">
			...
			<p><?php the_title( '<strong class="meta-title p-name">', '</strong> | ' ); ?><span itemprop="articleSection"><?php the_category( ', ' ); ?></span><?php $utils->the_permalink_date( ' | ', '', false ); ?></p>
			<?php do_action( 'themeberger_entry_footer' ); ?>
			<p><?php esc_html_e( 'Shortlink:', 'themeberger-basic' ); ?> <?php $utils->the_shorturl(); ?></p>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class( 'content h-entry post-entry type-post-' . $post_type_slug ); ?> itemprop="hasPart" itemscope itemtype="http://schema.org/BlogPosting">
		...
		<div class="content-supercard type-<?php echo esc_attr( $post_type_slug ); ?>">
			...
			<header class="entry-header">
				<?php $kicker->the_kicker( '<h6 class="entry-kicker">', '</h6>' ); ?>
				<?php the_title( '<h2 class="entry-title p-name"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">', '</a></h2>' ); ?>
				<?php $subtitle->the_subtitle( '<h4 class="entry-subtitle">', '</h4>' ); ?>
			</header><!-- .entry-header -->
			...
			<footer class="entry-footer">
				...
				<div class="category-date"><?php $utils->the_permalink_date( '', ' | ', false ); ?><?php the_category( ', ' ); ?></div>
			</footer><!-- .entry-footer -->
